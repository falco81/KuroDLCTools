...
### .kurodlc.json Structure (DOA Fortune Summer Pack 2 Example)
    ...
    "ItemTableData": [
        {
            ...
            "category": 17,
            "subcategory": 16,
            "name": "Agnès' Neo Venus Swimsuit",
            "desc": "DOA Neo Venus Swimsuit for Agnès",
            "price": 100,
            "stack_size": 1,
            // ... other properties
        }
    ...
    "DLCTableData": [
        {
            ...
            "quantity": [1, 1, 1, 1, 1],
            "name": "DOA Fortune Summer Pack 2",
            "desc": "DOA Neo Venus Swimsuits",
            // ... other properties
        }
    ]
}
...
**Character Restrictions** (from DOA Fortune Summer Pack 2):
- `char_restrict: 1` - Agnès
- `char_restrict: 6` - Risette
- `char_restrict: 11` - Elaine
- `char_restrict: 18` - Nadia
- `char_restrict: 19` - Renne

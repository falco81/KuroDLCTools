...
if len(sys.argv) < 2:
    print("""
Usage: python find_unique_item_id.py <mode_or_file>
...
Example:
  python find_unique_item_id.py costume1.kurodlc.json
  python find_unique_item_id.py searchall
  python find_unique_item_id.py searchallbydlc
  python find_unique_item_id.py searchallline
""")
    sys.exit(1)
